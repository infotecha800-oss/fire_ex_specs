/* grid background animation — BLACK theme version */
...
function initGridAnimation() {
  ...
  function draw() {
    ...
    for (let r = 0; r < rows; r++) {
      ...
      for (let c = 0; c < cols - 1; c++) {
        ...
        if (total > 0.01) {
          ...
          g.addColorStop(0.5, `rgba(0, 0, 0, ${a + 0.1})`);
    ...
    for (let c = 0; c < cols; c++) {
      for (let r = 0; r < rows; r++) {
        ...
        if (total < 0.01) {
          ...
          grd.addColorStop(0, `rgba(0, 0, 0, ${0.9 * total})`);
          ...
          if (total > 0.5) {
            ...
            ctx.fillStyle = `rgba(0, 0, 0, ${total * 0.9})`; ctx.fill();
          }
        }
      }
    }
    ...
    if (mx > 0 && mx < W && my > 0 && my < H) {
      ...
      rg.addColorStop(0,   'rgba(0, 0, 0, 0.06)');
      rg.addColorStop(0.4, 'rgba(0, 0, 0, 0.03)');
    ...
    for (const cl of clicks) {
      ...
      rg2.addColorStop(0.5, `rgba(0, 0, 0, ${cl.life * 0.14})`);
